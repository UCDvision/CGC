...
class ResNet(nn.Module):
    ...
    def forward(self, images, vanilla=False, vanilla_with_feats=False):
        """
        This function serves as the wrapper which computes the logits/feature outputs as necessary.
        :param images: input images for computing logits/feats
